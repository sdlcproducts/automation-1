...
import pageobject.ByePage;

//<IMPORTS>

public class ByeStepDef {
    ...
    public ByeStepDef(WebDriverFactory contentSteps){
...
// Write code here that turns the phrase above into concrete actions
        ByePage byePage = new ByePage(driver);
        byePage.writeText(RandomStringUtils.randomAlphanumeric(20), "TEXTBOX21");
//<CODE>
    }
...
// Write code here that turns the phrase above into concrete actions
        ByePage byePage = new ByePage(driver);
        byePage.writeText(param31, "TEXTBOX32");
//<CODE>
    }
