...
public class AADriver {
  ...
  /**
   * Verifies existence of the object with attribute Identifier=attibuteValue. Returns true of
   * object exists.
   *
   * @param ObjectName The object name eg: exceptionsPageTitle within <By exceptionsPageTitle =
   *                   By.xpath("//p[.='Exception Summary']");>
   */
  public boolean verifyObjectPresent(By ObjectName) {
    ...
    try {
      ...
      if (driver.findElements(ObjectName).size() > 0) {
        return true;
      } else {
        return false;
      }
      ...
      throw new NoSuchElementException(
          "Error occured in verifyObjectPresent(" + ObjectName.toString() + "). Message:" + e);
    }
   ...
   * @author Mehraj Verifies existence of the object with attribute Identifier=attibuteValue.
   * Returns true of object exists.
   */
  public void clickButton(String buttonName) {
    buttonName = buttonName.toLowerCase();
    By button = By.xpath(
        "//button[translate(@value,'ABCDEFGHIJKLMNOPQRSTUVWXYZ','abcdefghijklmnopqrstuvwxyz') = '"
            + buttonName + "'][1]");
    try {
      ...
      System.out.println(e);
      throw new NoSuchElementException(
          "Error occured in clickButton(" + button.toString() + "). Message:" + e);
    }
  ...
  public boolean verifyButtonPresent(String buttonName) {
    buttonName = buttonName.toLowerCase();
    By button = By.xpath(
        "//button[translate(.,'ABCDEFGHIJKLMNOPQRSTUVWXYZ','abcdefghijklmnopqrstuvwxyz') = '"
            + buttonName + "'][1]");
    try {
      object = wait.until(ExpectedConditions.elementToBeClickable(button));
      if (driver.findElements(button).size() > 0) {
        return true;
      } else {
        return false;
      }
      ...
      System.out.println(e);
      throw new NoSuchElementException(
          "Error occured in verifyButtonPresent(" + button.toString() + "). Message:" + e);
    }
  ...
  /**
   * Verifies existence of the object with attributes Identifier1=Value1 and Identifier2=Value2.
   * Returns true if object exists. Implemented for Identifier1=class and
   * Identifier2=text/containingText/id/name. Can be implemented for additional identifiers and
   * combinations using the same pattern
   *
   ...
   */
  public boolean verifyObjectPresent(String ObjectName, String Identifier1, String Value1,
    ...
    try {
      ...
      switch (Identifier1.toLowerCase()) {
        case "class":
          switch (Identifier2.toLowerCase()) {
            ...
            case "containingText":
              xpath =
                  "//*[contains(@class,'" + Value1 + "') and @contains(text(),'" + Value2 + "']";
              return verifyObjectPresent(ObjectName, "xpath", xpath);
            case "id":
      ...
      System.out.println(e);
      throw new NoSuchElementException(
          "Error occured in verifyObjectPresent(" + ObjectName + "," + Identifier1 + "," + Value1
              + "+," + Identifier2 + "+," + Value2 + "). Message:" + e);
    }
  }
  ...
  public boolean verifyObjectPresent(String ObjectName, String Identifier, String attibuteValue) {
    try {
      ...
      switch (Identifier.toLowerCase()) {
        case "linktext":
          if (driver.findElements(By.linkText(attibuteValue)).size() > 0) {
            return true;
          } else {
            return false;
          }
        case "title":
          object = (WebElement) wait.until(ExpectedConditions
              .visibilityOfElementLocated(By.xpath("//*[@title='" + attibuteValue + "']")));
          if (driver.findElements(By.xpath("//*[@title='" + attibuteValue + "']")).size() > 0) {
            return true;
          } else {
            return false;
          }
        ...
        case "class":
          object = (WebElement) wait.until(
              ExpectedConditions.visibilityOfElementLocated(By.cssSelector("." + attibuteValue)));
          if (driver.findElements(By.cssSelector("." + attibuteValue)).size() > 0) {
            return true;
          } else {
            return false;
          }
        ...
        case "xpath":
          object = (WebElement) wait
              .until(ExpectedConditions.visibilityOfElementLocated(By.xpath(attibuteValue)));
          Thread.sleep(1000);
          if (driver.findElements(By.xpath(attibuteValue)).size() > 0) {
            return true;
          } else {
            return false;
          }
      ...
      System.out.println(e);
      throw new NoSuchElementException(
          "Error occured in verifyObjectPresent(" + ObjectName + "," + attibuteValue + ","
              + Identifier + "). Message:" + e);
    }
  }
    ...
    try {
      switch (identifier) {
        case "link":
          Thread.sleep(1000);
          object = (WebElement) wait
              .until(ExpectedConditions.visibilityOfElementLocated(By.linkText(attributeValue)));
          jse.executeScript("arguments[0].click();",
              driver.findElement(By.linkText(attributeValue)));
          //driver.findElement(By.linkText(attibuteValue)).click();
          break;
        case "id":
          object = (WebElement) wait
              .until(ExpectedConditions.visibilityOfElementLocated(By.id(attributeValue)));
          jse.executeScript("arguments[0].click();", driver.findElement(By.id(attributeValue)));
          //driver.findElement(By.id(attibuteValue)).click();
          break;
        case "name":
          object = (WebElement) wait
              .until(ExpectedConditions.visibilityOfElementLocated(By.name(attributeValue)));
        ...
        case "class":
          object = (WebElement) wait.until(
              ExpectedConditions.visibilityOfElementLocated(By.cssSelector("." + attributeValue)));
          jse.executeScript("arguments[0].click();",
      ...
      System.out.println(e);
      throw new NoSuchElementException(
          "Error occured in click(" + ObjectName + "," + identifier + "," + attributeValue
              + "). Message:" + e);
    }
  }

  /**
   * This is used for class containing text, but can be extended for other identifiers as well using
   * the same pattern
   *
   * @param ObjectName  The object type eg: link, button, etc
   * @param Identifier1 The name of the first identifier to be used eg: class, id, etc
   ...
   * @param Value2      The value of the second identifier
   */
  public void click(String ObjectName, String Identifier1, String Value1, String Identifier2,
      String Value2) {
    try {
      String xpath;
      Thread.sleep(2000);
      ...
      System.out.println(e);
      throw new NoSuchElementException(
          "Error occured in click(" + ObjectName + "," + Identifier1 + "," + Value1 + "+,"
              + Identifier2 + "+," + Value2 + "). Message:" + e);
    }
  }
  ...
  public void type(String text, String identifier, String attibuteValue) {
    ...
    try {
      switch (identifier) {
        ...
        case "id":
          object = (WebElement) wait
              .until(ExpectedConditions.visibilityOfElementLocated(By.id(attibuteValue)));
        ...
        case "xpath":
          ...
          break;
        default:
          object = (WebElement) wait.until(ExpectedConditions.visibilityOfElementLocated(
              By.xpath("//*[@" + identifier + "='" + attibuteValue + "']")));
          driver.findElement(By.xpath("//*[@" + identifier + "='" + attibuteValue + "']"))
              .sendKeys(text);
          break;
      }
    } catch (Exception e) {
      System.out.println(e);
      throw new NoSuchElementException(
          "Error occured in type(" + text + "," + identifier + "," + attibuteValue + "). Message:"
              + e);
    }
  }
  ...
  public boolean verifyPageOpened(String title) {
    try {
      if (driver.findElements(By.xpath("//*[@title='" + title + "']")).size() > 0) {
        return true;
      } else {
        return false;
      }
      ...
      System.out.println(e);
      throw new NoSuchElementException(
          "Error occured in verifyPageOpened(" + title + "). Message:" + e);
    }
  }
...
//	                    jse.executeScript("arguments[0].click();",driver.findElement(By.id(attibuteValue)));
        ...
        case "name":
          object = (WebElement) wait
              .until(ExpectedConditions.visibilityOfElementLocated(By.name(attibuteValue)));
          act.doubleClick(object).perform();
...
//	                    jse.executeScript("arguments[0].click();",driver.findElement(By.xpath(xpath)));
      ...
      System.out.println(e);
      throw new NoSuchElementException(
          "Error occured in doubleClick(" + ObjectName + "). Message:" + e);
    }
  }
   ...
   * @param Value2      The value of the second identifier
   */
  public void doubleClick(String ObjectName, String Identifier1, String Value1, String Identifier2,
      String Value2) {
    Actions act = new Actions(driver);
    try {
      String xpath;
...
//	                          jse.executeScript("arguments[0].click();", driver.findElement(By.xpath(xpath)));
      ...
      System.out.println(e);
      throw new NoSuchElementException(
          "Error occured in doubleClick(" + ObjectName + "," + Identifier1 + "," + Value1 + "+,"
              + Identifier2 + "+," + Value2 + "). Message:" + e);
    }
  }
  ...
  public void clearText(String ObjectName, String identifier, String attibuteValue) {
    try {
      ...
      System.out.println(e);
      throw new NoSuchElementException(
          "Error occured in clearText(" + ObjectName + "). Message:" + e);
    }
  }

  /**
   * rightClick Function   -- Example: And I right click on object identified by "text" "Booking
   * Party DB Entity" then I select item identified by "text" "Create Attribute..."
   *
   ...
   */
  public void rightClick(String Identifier1, String Value1, String Identifier2, String Value2)
      throws InterruptedException {
    ...
    try {
      switch (Identifier1) {
        case "text":
          ...
          object = (WebElement) wait.until(
              ExpectedConditions.visibilityOfElementLocated(By.xpath(xpath_rightClickableObj)));
          action.contextClick(driver.findElements(By.xpath(xpath_rightClickableObj)).get(0)).build()
              .perform();
          Thread.sleep(2000);
          break;
        case "class":
      ...
      System.out.println(e);
      throw new NoSuchElementException(
          "Error occured in rightClickable object (" + Identifier1 + "). Message:" + e);
    }
    ...
    try {
      switch (Identifier2) {
        case "text":
          ...
          object = (WebElement) wait
              .until(ExpectedConditions.visibilityOfElementLocated(By.xpath(xpath_MoveToElement)));
          break;
        case "class":
      ...
      System.out.println(e);
      throw new NoSuchElementException(
          "Error occured in MoveToElement object (" + Identifier2 + "). Message:" + e);
    }
    try {
   ...
   * @throws InterruptedException
   */
  public void rightClick(String objIdentifier1, String objValue1, String objIdentifier2,
      String objValue2, String mnuIdentifier1, String mnuValue1, String mnuIdentifier2,
      String mnuValue2, String subMnuIdentifier1, String subMnuValue1, String subMnuIdentifier2,
      String subMnuValue2) throws InterruptedException {
    String xpath_rightClickableObj = "";
    ...
    try {
      switch (objIdentifier1.toLowerCase()) {
        case "class":
          switch (objIdentifier2.toLowerCase()) {
            case "text":
              xpath_rightClickableObj =
                  "//*[contains(@class,'" + objValue1 + "') and contains(text(),'" + objValue2
                      + "')]";
              object = (WebElement) wait.until(
                  ExpectedConditions.visibilityOfElementLocated(By.xpath(xpath_rightClickableObj)));
              action.contextClick(driver.findElements(By.xpath(xpath_rightClickableObj)).get(0))
                  .build().perform();
              Thread.sleep(2000);
          }
      }
      ...
      System.out.println(e);
      throw new NoSuchElementException(
          "Error occured in rightClickable object (" + objIdentifier2 + "). Message:" + e);
    }
    // ****************   mnuIdentifier
    try {
      switch (mnuIdentifier1.toLowerCase()) {
        case "class":
          switch (mnuIdentifier2.toLowerCase()) {
            case "text":
              xpath_MoveToElement1 =
                  "//*[contains(@class,'" + mnuValue1 + "') and text()='" + mnuValue2 + "']";
              object = (WebElement) wait.until(
                  ExpectedConditions.visibilityOfElementLocated(By.xpath(xpath_MoveToElement1)));
              action.moveToElement(driver.findElement(By.xpath(xpath_MoveToElement1))).build()
                  .perform();
              Thread.sleep(1000);
              // break;
            ...
            case "containstext":
              xpath_MoveToElement1 =
                  "//*[contains(@class,'" + mnuValue1 + "') and contains(text(),'" + mnuValue2
                      + "')]";
              object = (WebElement) wait.until(
                  ExpectedConditions.visibilityOfElementLocated(By.xpath(xpath_MoveToElement1)));
              action.moveToElement(driver.findElement(By.xpath(xpath_MoveToElement1))).build()
      ...
      System.out.println(e);
      throw new NoSuchElementException(
          "Error occured in MoveToElement object (" + mnuIdentifier2 + "). Message:" + e);
    }
    ...
    try {
      switch (subMnuIdentifier1.toLowerCase()) {
        case "class":
          switch (subMnuIdentifier2.toLowerCase()) {
            case "text":
              xpath_MoveToElement2 =
                  "//*[contains(@class,'" + subMnuValue1 + "') and text()='" + subMnuValue2 + "']";
              object = (WebElement) wait.until(
                  ExpectedConditions.visibilityOfElementLocated(By.xpath(xpath_MoveToElement2)));
              //break;
            case "containstext":
              xpath_MoveToElement2 =
                  "//*[contains(@class,'" + subMnuValue1 + "') and contains(text(),'" + subMnuValue2
                      + "')]";
              object = (WebElement) wait.until(
                  ExpectedConditions.visibilityOfElementLocated(By.xpath(xpath_MoveToElement2)));
              //break;
      ...
      System.out.println(e);
      throw new NoSuchElementException(
          "Error occured in MoveToElement object (" + subMnuIdentifier2 + "). Message:" + e);
    }
    try {
  ...
  /**
   * Function verifyTextInTextArea - This function will search and verify any mentioned text in a
   * particular tag or node
   *
   * @param xpath
   * @throws InterruptedException
   */
  public void scrollElement(String xpath) {
    try {
      ...
      System.out.println(e);
      throw new NoSuchElementException(
          "Error occured in scrollElement(" + xpath + "). Message:" + e);
    }
  }
  ...
  public void mouseHover(String ObjectName, String attributeValue, String identifier) {
    try {
      ...
      switch (attributeValue.toLowerCase()) {
        case "xpath":
          object = (WebElement) wait
              .until(ExpectedConditions.visibilityOfElementLocated(By.xpath(identifier)));
  ...
  public boolean isDisabledElement(String searchType, String identifier, String identifierValue)
      throws Throwable {
    ...
    try {
      switch (identifier) {
        case "text":
          ...
          if (driver.findElement(By.xpath(xpath1)).isEnabled()) {
            return true;
          } else {
            return false;
          }
        case "xpath":
          if (driver.findElement(By.xpath(identifierValue)).isEnabled()) {
            return true;
          } else {
            return false;
          }
      ...
      System.out.println(e);
      throw new NoSuchElementException(
          "Error occured in verifyAbsenceInReportDetails(" + searchType + "). Message:" + e);
    }
  }
...
//	            String alertmsg = driver.switchTo().alert().getText();
   ...
   * @throws InterruptedException
   */
  public void rightClick(String xpath_rightClickableObj, String xpath_MoveToElement)
      throws InterruptedException {
    try {
      this.driver = WebDriverFactory.driver;
      jse = (JavascriptExecutor) driver;
      wait = new WebDriverWait(driver, 20);
      object = (WebElement) wait
          .until(ExpectedConditions.visibilityOfElementLocated(By.xpath(xpath_rightClickableObj)));
      Actions action = new Actions(driver);
//	            Assert.assertTrue("Right clickable object not fpond.", driver.findElements(By.xpath(xpath_rightClickableObj)).size() > 0);
   ...
   *
   * @param ObjectName: Name of the object on which to double click. This should be defined in the
   *                    page.java class
   ...
   *
   * @param ObjectName: Name of the object on which to type. This should be defined in the page.java
   *                    class
   * @param pageName:   Name of the page (class) in which the object is  defined
   * @throws Exception
   */
  public void typeOnPage(String text, String ObjectName, String pageName) throws Exception {
    try {
      ...
      throw new Exception(
          "ERROR: typeOnPage(" + text + "," + ObjectName + "," + pageName + ")" + e);
    }
  }
  ...
  public boolean verifyObjectPresentOnPage(String ObjectName, String pageName) throws Exception {
    try {
      ...
      throw new Exception(
          "ERROR: verifyObjectPresentOnPage(" + ObjectName + "," + pageName + ")" + e);
    }
  }
...
//	            System.out.println(field.get(obj));
      object = (WebElement) wait
          .until(ExpectedConditions.visibilityOfElementLocated((By) field.get(obj)));
      act.doubleClick(object).perform();
      field = null;
      obj = null;
      act = null;
   ...
   *
   * @param ObjectName: Name of the object to be cleared. This should be defined in the page.java
   *                    class
   * @param pageName:   Name of the page (class) in which the object is  defined
   * @throws Exception
   */
...
//	            System.out.println(field.get(obj));
   ...
   *
   * @param ObjectName: Name of the object on which to hover. This should be defined in the
   *                    page.java class
   * @param pageName:   Name of the page (class) in which the object is  defined
   * @throws Exception
   */
...
//	            System.out.println(field.get(obj));
   ...
   *
   * @param ObjectName: Name of the object on which to right click. This should be defined in the
   *                    page.java class
   * @param pageName:   Name of the page (class) in which the object is  defined
   * @throws Exception
   */
   ...
   *
   * @param rtClickObjectName: Name of the object on which to right click. This should be defined in
   *                           the page.java class
   * @param selectObjectName:  Name of the object that should be selected after right click. This
   *                           should be defined in the page.java class
   * @param pageName:          Name of the page (class) in which these objects are defined
   * @throws Exception
   */
  public void rightClickOnPage(String rtClickObjectName, String selectObjectName, String pageName)
      throws Exception {
    Actions act = new Actions(driver);
    try {
      Class<?> clazz = Class.forName("main.java.pageobject." + pageName);
      ...
      System.out.println(
          "ERROR: rightClickOnPage(" + rtClickObjectName + "," + selectObjectName + "," + pageName
              + ")");
      throw new Exception(
          "ERROR: rightClickOnPage(" + rtClickObjectName + "," + selectObjectName + "," + pageName
              + ")" + e);
   ...
   * @param dropdown:  Name of the dropdown where the selection is to be made. This should be
   *                   defined in the page.java class*
   * @param pageName:  Name of the page (class) in which the object is  defined
   * @throws Exception
   */
  public void selectDropdownOnPage(String selection, String dropdown, String pageName)
      throws Exception {
    try {
      Class<?> clazz = Class.forName("main.java.pageobject." + pageName);
      Object obj = clazz.newInstance();
      ...
      System.out
          .println("ERROR: selectDropdown(" + selection + "," + dropdown + "," + pageName + ")");
      throw new Exception(
          "ERROR: selectDropdown(" + selection + "," + dropdown + "," + pageName + ")" + e);
    }
  }
